...
import { getFinancialSummary } from '../lib/canonicalFinance';
...
export const TransactionsView: React.FC = () => {
  ...
  // Aggregate stats for filtered list use the same canonical engine as Dashboard/Reports.
  const filteredSummary = useMemo(() => getFinancialSummary(filteredTransactions), [filteredTransactions]);
  const filteredIncome = filteredSummary.income;
  const filteredExpenses = filteredSummary.expenses;
