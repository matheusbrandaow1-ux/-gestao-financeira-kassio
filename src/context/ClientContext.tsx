...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  { id: 'cat-leisure', groupId: 'grp-estilo-vida', groupName: 'Estilo de Vida', name: 'Lazer, Viagens & Restaurantes', type: 'DESPESA', color: '#8B5CF6', icon: 'Palmtree', isSystem: true, subcategories: ['Restaurantes', 'Viagens', 'Entretenimento'] },
  { id: 'cat-utilities', groupId: 'grp-servicos', groupName: 'Serviços', name: 'Assinaturas & Telecomunicações', type: 'DESPESA', color: '#64748B', icon: 'Tv', isSystem: true, subcategories: ['Internet', 'Streaming', 'Celular'] },
