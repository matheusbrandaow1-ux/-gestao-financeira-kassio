        ...
        <div className="flex items-center flex-wrap gap-2.5 sm:gap-3">
          ...
          <div className="flex items-center gap-2 px-1 py-1.5 text-xs">
            ...
            <button
              ...
              disabled={isSyncing}
              title="Atualizar Money"
              className="ml-1 inline-flex items-center gap-1.5 px-2.5 py-2 rounded-lg hover:bg-slate-800 text-slate-300 hover:text-white transition-colors disabled:opacity-50"
            >
              <RefreshCw className={`w-3.5 h-3.5 ${isSyncing ? 'animate-spin text-amber-400' : ''}`} />
              <span className="hidden sm:inline text-[11px] font-semibold">Atualizar Money</span>
            </button>
          </div>
